...
#define SUBWINDOWWHITE( SUBWINDOWBLACK_X, SUBWINDOWBLACK_Y, SUBWINDOWBLACK_W, SUBWINDOWBLACK_H, SUBWINDOWBLACK_TEXT )	\
	itemDef {																									\
		name		"subwindowblack"##SUBWINDOWBLACK_TEXT														\
		group		GROUP_NAME																					\
		rect		$evalfloat(SUBWINDOWBLACK_X) $evalfloat(SUBWINDOWBLACK_Y) $evalfloat(SUBWINDOWBLACK_W) $evalfloat(SUBWINDOWBLACK_H)	\
...
#define SUBWINDOWWHITE2( SUBWINDOWBLACK_X, SUBWINDOWBLACK_Y, SUBWINDOWBLACK_W, SUBWINDOWBLACK_H, SUBWINDOWBLACK_TEXT )	\
	itemDef {																									\
		name		"subwindowblack"##SUBWINDOWBLACK_TEXT														\
		group		GROUP_NAME																					\
		rect		$evalfloat(SUBWINDOWBLACK_X) $evalfloat(SUBWINDOWBLACK_Y) $evalfloat(SUBWINDOWBLACK_W) $evalfloat(SUBWINDOWBLACK_H)	\
...
#define SUBWINDOWWHITE2_OLD( SUBWINDOWBLACK_X, SUBWINDOWBLACK_Y, SUBWINDOWBLACK_W, SUBWINDOWBLACK_H, SUBWINDOWBLACK_TEXT )	\
	itemDef {																									\
		name		"subwindowblack"##SUBWINDOWBLACK_TEXT														\
		group		GROUP_NAME																					\
		rect		$evalfloat(SUBWINDOWBLACK_X) $evalfloat(SUBWINDOWBLACK_Y) $evalfloat(SUBWINDOWBLACK_W) $evalfloat(SUBWINDOWBLACK_H)	\
...
#define BUTTON( BUTTON_X, BUTTON_Y, BUTTON_W, BUTTON_H, BUTTON_TEXT, BUTTON_TEXT_SCALE, BUTTON_TEXT_ALIGN_Y, BUTTON_ACTION )					\
	itemDef {															\
		...
		mouseEnter {													\
			...
			setitemcolor "bttn"##BUTTON_TEXT backcolor .0 .0 .1 1		\
		}																\
																		\
		mouseExit {														\
			setitemcolor "bttn"##BUTTON_TEXT forecolor .9 .9 1 1 ;		\
			setitemcolor "bttn"##BUTTON_TEXT backcolor .0 .0 .1 1		\
		}																\
																		\
		action {														\
...
#define BUTTONEXT( BUTTONEXT_X, BUTTONEXT_Y, BUTTONEXT_W, BUTTONEXT_H, BUTTONEXT_TEXT, BUTTONEXT_TEXT_SCALE, BUTTONEXT_TEXT_ALIGN_Y, BUTTONEXT_ACTION, BUTTONEXT_EXT )					\
	itemDef {															\
		...
		mouseEnter {													\
			...
			setitemcolor "bttnext"##BUTTONEXT_TEXT backcolor .0 .0 .1 1		\
		}																\
																		\
		mouseExit {														\
			setitemcolor "bttnext"##BUTTONEXT_TEXT forecolor .9 .9 1 1 ;		\
			setitemcolor "bttnext"##BUTTONEXT_TEXT backcolor .0 .0 .1 1		\
		}																\
																		\
		action {														\
...
#define NAMEDBUTTON( NAMEDBUTTON_NAME, NAMEDBUTTON_X, NAMEDBUTTON_Y, NAMEDBUTTON_W, NAMEDBUTTON_H, NAMEDBUTTON_TEXT, NAMEDBUTTON_TEXT_SCALE, NAMEDBUTTON_TEXT_ALIGN_Y, NAMEDBUTTON_ACTION )					\
	itemDef {															\
		...
		mouseEnter {													\
			...
			setitemcolor NAMEDBUTTON_NAME backcolor .0 .0 .1 1		\
		}																\
																		\
		mouseExit {														\
			setitemcolor NAMEDBUTTON_NAME forecolor .9 .9 1 1 ;		\
			setitemcolor NAMEDBUTTON_NAME backcolor .0 .0 .1 1		\
		}																\
																		\
		action {														\
...
#define NAMEDBUTTONEXT( NAMEDBUTTONEXT_NAME, NAMEDBUTTONEXT_X, NAMEDBUTTONEXT_Y, NAMEDBUTTONEXT_W, NAMEDBUTTONEXT_H, NAMEDBUTTONEXT_TEXT, NAMEDBUTTONEXT_TEXT_SCALE, NAMEDBUTTONEXT_TEXT_ALIGN_Y, NAMEDBUTTONEXT_ACTION, NAMEDBUTTONEXT_EXT )					\
	itemDef {															\
		...
		mouseEnter {													\
			...
			setitemcolor NAMEDBUTTONEXT_NAME backcolor .0 .0 .1 1		\
		}																\
																		\
		mouseExit {														\
			setitemcolor NAMEDBUTTONEXT_NAME forecolor .9 .9 1 1 ;		\
			setitemcolor NAMEDBUTTONEXT_NAME backcolor .0 .0 .1 1		\
		}																\
																		\
		action {														\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "yn"##YESNO_TEXT forecolor .9 .9 .9 1 ;		\
																		...
																		\
		mouseExit {														\
			setitemcolor "yn"##YESNO_TEXT forecolor .6 .6 .8 1 ;		\
		}																\
																		\
		action {														\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "ynalx"##YESNOALIGNX_TEXT forecolor .9 .9 .9 1 ;		\
																		...
																		\
		mouseExit {														\
			setitemcolor "ynalx"##YESNOALIGNX_TEXT forecolor .6 .6 .8 1 ;		\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "ynaction"##YESNOACTION_TEXT forecolor .9 .9 .9 1 ;	\
																		...
																		\
		mouseExit {														\
			setitemcolor "ynaction"##YESNOACTION_TEXT forecolor .6 .6 .8 1 ;	\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "check"##CHECKBOX_TEXT forecolor .9 .9 .9 1 ;	\
																		...
																		\
		mouseExit {														\
			setitemcolor "check"##CHECKBOX_TEXT forecolor .6 .6 .8 1 ;	\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "checkalx"##CHECKBOXALIGNX_TEXT forecolor .9 .9 .9 1 ;	\
																		...
																		\
		mouseExit {														\
			setitemcolor "checkalx"##CHECKBOXALIGNX_TEXT forecolor .6 .6 .8 1 ;	\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor CHECKBOXNOTEXT_NAME forecolor .9 .9 .9 1 ;		\
																		...
																		\
		mouseExit {														\
			setitemcolor CHECKBOXNOTEXT_NAME forecolor .6 .6 .8 1 ;		\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor CHECKBOXNOTEXTACTION_NAME forecolor .9 .9 .9 1 ;		\
																		...
																		\
		mouseExit {														\
			setitemcolor CHECKBOXNOTEXTACTION_NAME forecolor .6 .6 .8 1 ;		\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "checkaction"##CHECKBOXACTION_TEXT forecolor .9 .9 .9 1 ;	\
																		...
																		\
		mouseExit {														\
			setitemcolor "checkaction"##CHECKBOXACTION_TEXT forecolor .6 .6 .8 1 ;	\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "checkactionalx"##CHECKBOXALIGNXACTION_TEXT forecolor .9 .9 .9 1 ;	\
																		...
																		\
		mouseExit {														\
			setitemcolor "checkactionalx"##CHECKBOXALIGNXACTION_TEXT forecolor .6 .6 .8 1 ;	\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "tricheckaction"##TRICHECKBOXACTION_TEXT forecolor .9 .9 .9 1 ;	\
																		...
																		\
		mouseExit {														\
			setitemcolor "tricheckaction"##TRICHECKBOXACTION_TEXT forecolor .6 .6 .8 1 ;	\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "tricheckactionmulti"##TRICHECKBOXACTIONMULTI_CVAR forecolor .9 .9 .9 1 ;	\
																		...
																		\
		mouseExit {														\
			setitemcolor "tricheckactionmulti"##TRICHECKBOXACTIONMULTI_CVAR forecolor .6 .6 .8 1 ;	\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "multi"##MULTI_TEXT forecolor .9 .9 .9 1 ;		\
																		...
																		\
		mouseExit {														\
			setitemcolor "multi"##MULTI_TEXT forecolor .6 .6 .8 1 ;		\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "multileft"##MULTILEFT_TEXT forecolor .9 .9 .9 1 ;		\
																		...
																		\
		mouseExit {														\
			setitemcolor "multileft"##MULTILEFT_TEXT forecolor .6 .6 .8 1 ;		\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "multiaction"##MULTIACTION_TEXT forecolor .9 .9 .9 1 ;		\
																		...
																		\
		mouseExit {														\
			setitemcolor "multiaction"##MULTIACTION_TEXT forecolor .6 .6 .8 1 ;		\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "multiactionleft"##MULTIACTIONLEFT_TEXT forecolor .9 .9 .9 1 ;		\
																		...
																		\
		mouseExit {														\
			setitemcolor "multiactionleft"##MULTIACTIONLEFT_TEXT forecolor .6 .6 .8 1 ;		\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "slider"##SLIDER_TEXT forecolor .9 .9 .9 1 ;		\
																		...
																		\
		mouseExit {														\
			setitemcolor "slider"##SLIDER_TEXT forecolor .6 .6 .8 1 ;		\
		}																\
    }
    ...
    itemDef {															\
		...
		mouseEnter {													\
			setitemcolor "bind"##BIND_TEXT forecolor .9 .9 .9 1 ;		\
																		...
																		\
		mouseExit {														\
			setitemcolor "bind"##BIND_TEXT forecolor .6 .6 .8 1 ;		\
		}																\
																		\
		action {														\
			play "sound/menu/filter.wav" ;								\
