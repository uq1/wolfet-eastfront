...
#define MAX_MAPS_PER_CAMPAIGN	30
// END Mad Doc - TDF
...
#define CS_ETE_INFO						40
#define CS_ETE_SKILLLEVELS				41
...
typedef struct {
	...
	int			entityNum;
#ifdef __VEHICLES__
	qboolean	tankbox_setup;
	vec3_t		original_mins;
	vec3_t		original_maxs;
	float		pml_tank_movetime;
	qboolean	pml_tank_forwardmove;
#endif //__VEHICLES__
	// Unique1...
...
// JPW NERVE
#ifdef __EF__
#define MAX_WEAPS_IN_BANK_MP	20 // UQ1: leaving plenty of room for our new 128 weapon limit!
#else //!__EF__
...
#ifdef __FRONTLINE__
#define	EF_BROWNING_ACTIVE	EF_NONSOLID_BMODEL	 // currently using an .30 cal , jaquboss
#else //!__FRONTLINE__
#define	EF_CLOAKED			EF_NONSOLID_BMODEL	 // currently using an .30 cal , jaquboss
#endif
...
#define EF_FAKEBMODEL		0x00000400		// Unqiue1: REUSE THIS AS NEEDED!
...
#ifdef __VEHICLES__
#define EF_VEHICLE				0x00010000		// jaquboss, player is tank :o
#define EF_TURRETMOVE		EF_FAKEBMODEL	// jaquboss 
#else //!__VEHICLES__
#define EF_SPARE2			0x00010000		// Gordon: freed
#endif //__VEHICLES__
#define	EF_PATH_LINK		0x00020000		// Gordon: linking trains together
//#define	EF_SPARE3			EF_PATH_LINK	// Unique1: Free for players...
#define	EF_PLAYDEAD			EF_PATH_LINK	// Unique1: Free for players...
...
#define EF_AIMING			0x00800000		// Gordon: freed

// !! NOTE: only place flags that don't need to go to the client beyond 0x00800000
#define	EF_MOTION			0x01000000		// Gordon: freed
//#define	EF_SPARE5			0x02000000		// Gordon: freed
#define EF_VIEWING_CAMERA	0x02000000		// player is viewing a camera
...
// UQ1: entityState_t->eFlags on SecondaryEntity...
#define	EX_SHELLSHOCK		0x00000001		// UQ1: Player is shellshocked...
#define EX_SPARE1			0x00000002		// UQ1: free
#define	EX_SPARE2 			0x00000004		// UQ1: free
#define	EX_SPARE3 			0x00000008		// UQ1: free
#define	EX_SPARE4			0x00000010		// UQ1: free
#define	EX_SPARE5			0x00000020		// UQ1: free
#define	EX_SPARE6			0x00000040		// UQ1: free
#define	EX_SPARE7			0x00000080		// UQ1: free
#define EX_SPARE8			0x00000100		// UQ1: free
#define	EX_SPARE9			0x00000200		// UQ1: free
#define EX_SPARE10			0x00000400		// UQ1: free
#define	EX_SPARE11			0x00000800		// UQ1: free
#define EX_SPARE12			0x00001000		// UQ1: free
#define EX_SPARE13			0x00002000		// UQ1: free
#define	EX_SPARE14			0x00004000		// UQ1: free
#define	EX_SPARE15			0x00008000		// UQ1: free
#define EX_SPARE16			0x00010000		// UQ1: free
#define	EX_SPARE17			0x00020000		// UQ1: free
#define EX_SPARE18			0x00040000		// UQ1: free
#define	EX_SPARE19			0x00080000		// UQ1: free
#define EX_SPARE20			0x00100000		// UQ1: free
#define EX_SPARE21			0x00200000		// UQ1: free
#define EX_SPARE22			0x00400000		// UQ1: free
#define EX_SPARE23			0x00800000		// UQ1: free
...
typedef enum {
	...
	WP_SILENCED_LUGER,							// 14	// used to be sp5
	WP_DYNAMITE,							// 15
	WP_SMOKETRAIL,						// 16
	WP_MAPMORTAR,						// 17	
	...
	WP_SVT40,									// 42
	WP_30CAL,									// 43
	WP_PTRS,									// 44  Masteries
	WP_AIRDROP_MARKER,							// 45  UQ1: For new sandbag spawn...
	// UQ1: --- END EF NEW ---

	WP_MAX_PRIMARY = WP_AIRDROP_MARKER,  //Masteries, MAX_PRIMARY?? -- UQ1: Weapons under here are alt-fire, etc.
...
// Gordon: ONLY secondaries below this mark, as they are checked >= WP_GPG40 && < WP_NUM_WEAPONS
	...
	WP_FG42SCOPE,						// 51
	WP_MORTAR_SET,						// 52
	WP_MEDIC_ADRENALINE,			// 53
	WP_AKIMBO_SILENCEDCOLT,	// 54
	WP_AKIMBO_SILENCEDLUGER,// 55
	WP_MOBILE_MG42_SET,			// 56

	// UQ1: --- START EF NEW ---
	WP_30CAL_SET,							// 57
	WP_PTRS_SET,                            // 58  Masteries
	// UQ1: --- END EF NEW ---
#else //!__EF__

	WP_MAX_PRIMARY = WP_AKIMBO_LUGER,
...
#define MISC_ADMINS_ONLY 4	// not used yet
#define MISC_KILLSTREAKS 8
...
extern const char* skillNames[SK_NUM_SKILLS+1];
extern const char* skillNamesLine1[SK_NUM_SKILLS+1];
extern const char* skillNamesLine2[SK_NUM_SKILLS+1];
extern const char* medalNames[SK_NUM_SKILLS+1];

#define NUM_SKILL_LEVELS 5

extern int skillLevels[SK_NUM_SKILLS+1][NUM_SKILL_LEVELS+1];
...
extern ammotable_t *GetAmmoTableData2(int ammoIndex);
extern ammotable_t *GetAmmoTableData(weapon_t weapon);
...
#define WP_LASTSECONDARY	WP_NUM_WEAPONS-1 //WP_SILENCED_COLT
#define WEAPS_ONE_HANDED	((1<<WP_KNIFE)|(1<<WP_LUGER)|(1<<WP_COLT)|(1<<WP_SILENCED_LUGER)|(1<<WP_SILENCED_COLT)|(1<<WP_GRENADE_LAUNCHER)|(1<<WP_GRENADE_PINEAPPLE))
...
#define IS_AUTORELOAD_WEAPON(weapon) \
			(	\
				...
				weapon==WP_SILENCED_COLT	|| weapon==WP_SILENCED_LUGER		|| \
				weapon==WP_GARAND	|| weapon==WP_K43_SCOPE		|| weapon==WP_FG42SCOPE		|| \
				weapon==WP_PPSH || weapon==WP_STG44 || weapon==WP_PPS || weapon==WP_SVT40 || weapon==WP_30CAL || weapon==WP_30CAL_SET 	|| weapon==WP_PTRS || weapon==WP_PTRS_SET	|| \
...
typedef enum {
	...
	MOD_SWAP_PLACES,
	MOD_TANKSHELL,
	MOD_PTRSSHELL,//Masteries, new event for antitank rifles
...
typedef enum
{
	...
	ANIM_COND_PRONING,			// UQ1: PRONING
	ANIM_COND_RELAXING,			// UQ1: RELAXING
	ANIM_COND_QUERY,			// UQ1: QUERY
	ANIM_COND_ALERT,			// UQ1: ALERT
...
typedef struct
{
	...
	animation_t			*animations[MAX_MODEL_ANIMATIONS+1];		// anim names, frame ranges, etc
	headAnimation_t		headAnims[MAX_HEAD_ANIMS+1];
	int					numAnimations, numHeadAnims;

	// parsed from script file
	animScript_t		scriptAnims[MAX_AISTATES+1][NUM_ANIM_MOVETYPES+1];			// locomotive anims, etc
	animScript_t		scriptCannedAnims[NUM_ANIM_MOVETYPES+1];					// played randomly
	animScript_t		scriptEvents[NUM_ANIM_EVENTTYPES+1];						// events that trigger special anims

	// global list of script items for this model
	animScriptItem_t	scriptItems[MAX_ANIMSCRIPT_ITEMS_PER_MODEL+1];
	int					numScriptItems;
...
//	int					clientModels[MAX_CLIENTS];		// so we know which model each client is using
	animModelInfo_t		modelInfo[MAX_ANIMSCRIPT_MODELS+1];
	int					clientConditions[MAX_GENTITIES+1/*MAX_CLIENTS*/][NUM_ANIM_CONDITIONS+1][2];
	//
...
extern	pathCorner_t		pathCorners[MAX_PATH_CORNERS+1];
...
struct splinePath_s {
	...
	pathCorner_t	controls[MAX_SPLINE_CONTROLS+1];
	int				numControls;
	splineSegment_t	segments[MAX_SPLINE_SEGMENTS+1];
...
extern	splinePath_t		splinePaths[MAX_SPLINE_PATHS+1];
...
#define GetAmmoTableData2(ammoIndex) ((ammotable_t*)(&ammoTableMP[ammoIndex]))
...
#ifdef __EF__
#define NUM_HEAVY_WEAPONS 10//Masteries added WP_PTRS and WP_PTRS_SET
#else //!__EF__
...
qboolean BG_Weapon_Is_Aimable ( int weapon ); // bg_animation.c
...
//
// character presets
#ifndef CHARACTERS_LOADED
#define CHARACTERS_LOADED 1
...
#ifdef __VEHICLES__
#ifndef VEHICLE_DEFINES

#define VEHICLE_DEFINES

typedef enum {
	VEHICLE_CLASS_NONE,
	VEHICLE_CLASS_LIGHT_TANK,
	VEHICLE_CLASS_MEDIUM_TANK,
	VEHICLE_CLASS_HEAVY_TANK,
	VEHICLE_CLASS_HEAVY_ASSAULT_TANK,
	VEHICLE_CLASS_APC,
	VEHICLE_CLASS_JEEP,
	VEHICLE_CLASS_CAR,
	VEHICLE_CLASS_SHIP,
	VEHICLE_CLASS_PLANE,
	VEHICLE_CLASS_ARTILLERY,
	VEHICLE_CLASS_FLAMETANK,
	VEHICLE_NUM_CLASSES,
} vehicleClasses_t;

typedef enum {
	VEHICLE_TYPE_NONE,
	VEHICLE_TYPE_CHURCHILL,
	VEHICLE_TYPE_PANZER,
	VEHICLE_TYPE_KV1,
	VEHICLE_TYPE_PANZERIV,
	VEHICLE_TYPE_STUG3,
	VEHICLE_TYPE_T34,
	VEHICLE_TYPE_BT7,
	VEHICLE_TYPE_FLAK88,
	VEHICLE_TYPE_PAK,
	VEHICLE_TYPE_FLAMETANK,
	VEHICLE_TYPE_TIGERTANK,
	VEHICLE_TYPE_AXIS_APC,
	VEHICLE_TYPE_ALLIED_APC,
	VEHICLE_TYPE_PANZER2,
	VEHICLE_NUM_TYPES,
} vehicleTypes_t;
#endif //VEHICLE_DEFINES
#endif //__VEHICLES__
