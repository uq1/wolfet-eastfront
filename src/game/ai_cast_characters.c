...
//		"sound/weapons/melee/fstmiss.wav",		// follow - go with ordering player ("i'm with you" rather than "yes sir!")
	...
	//AICHAR_ELITEGUARD
	{
		...
		AITEAM_NAZI,
		"eliteguard/default",
		{WP_SILENCED_LUGER},		//----(SA)	TODO: replace w/ "silenced luger"
		BBOX_SMALL, {32,48},
		AIFL_CATCH_GRENADE|AIFL_STAND_IDLE2,
		NULL, NULL, NULL,
		NULL,
	...
	//AICHAR_STIMSOLDIER1
	{
		...
		AITEAM_NAZI,
		"stim/default",
		{WP_KNIFE},	// TODO: dual machinegun attack
		BBOX_LARGE, {48,64},
		AIFL_NO_RELOAD,
	...
	//AICHAR_STIMSOLDIER2
	{
		...
		AITEAM_NAZI,
		"stim/default",
		{WP_MP40, WP_KNIFE},	// attack1 is leaping rocket attack
		BBOX_LARGE, {48,64},
		AIFL_NO_RELOAD,
	...
	//AICHAR_STIMSOLDIER3
	{
		...
		AITEAM_NAZI,
		"stim/default",
		{WP_MP40, WP_FLAMETHROWER},	// no monster_attack1, since that's only used for the jumping rocket attack
		BBOX_LARGE, {48,64},
		AIFL_NO_RELOAD,
		AIFunc_StimSoldierAttack1Start, NULL, NULL,
		NULL,
	...
	//AICHAR_BLACKGUARD
	{
		...
		AITEAM_NAZI,
		"blackguard/default",
//		{WP_MP40, WP_GRENADE_LAUNCHER, WP_KNIFE},	// attack1 is melee kick
		{WP_FG42, WP_FG42SCOPE, WP_GRENADE_LAUNCHER, WP_KNIFE},	// attack1 is melee kick
		BBOX_SMALL, {32,48},
	...
	//AICHAR_HELGA
	{
		...
		{WP_KNIFE,WP_KNIFE/*,WP_KNIFE*/},	// starting weapons
	...
	//AICHAR_HEINRICH
	{
		...
		AITEAM_NAZI,
		"heinrich/default",
		{WP_KNIFE,WP_KNIFE,WP_KNIFE},	// attack3 is given to him by scripting
...
void AIChar_SetBBox( gentity_t *ent, cast_state_t *cs, qboolean useHeadTag )
{
	...
	} else if (trap_GetTag( ent->s.number, 0, "tag_head", &or )) {	// if not found, then just leave it
