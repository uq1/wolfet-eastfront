...
qboolean AICast_ScriptAction_Dummy( cast_state_t *cs, char *params)
{
	return qfalse;
}
...
cast_script_stack_action_t scriptActions[] =
{
	{"gotomarker",		AICast_ScriptAction_Dummy},
	{"runtomarker",		AICast_ScriptAction_Dummy},
	{"walktomarker",	AICast_ScriptAction_Dummy},
	{"crouchtomarker",	AICast_ScriptAction_Dummy},
	{"gotocast",		AICast_ScriptAction_Dummy},
	{"runtocast",		AICast_ScriptAction_Dummy},
	{"walktocast",		AICast_ScriptAction_Dummy},
	{"crouchtocast",	AICast_ScriptAction_Dummy},
	{"followcast",		AICast_ScriptAction_Dummy},
	{"playsound",		AICast_ScriptAction_Dummy},
	{"playanim",		AICast_ScriptAction_Dummy},
	{"clearanim",		AICast_ScriptAction_Dummy},
	{"wait",			AICast_ScriptAction_Dummy},
	{"abort_if_loadgame",AICast_ScriptAction_Dummy},	//----(SA)	added
	{"trigger",			AICast_ScriptAction_Dummy},
	{"setammo",			AICast_ScriptAction_Dummy},
	{"setclip",			AICast_ScriptAction_Dummy},			//----(SA)	added
	{"selectweapon",	AICast_ScriptAction_Dummy},
	{"noattack",		AICast_ScriptAction_Dummy},
	{"suggestweapon",	AICast_ScriptAction_Dummy},		//----(SA)	added
	{"attack",			AICast_ScriptAction_Dummy},
	{"givearmor",		AICast_ScriptAction_Dummy},			//----(SA)	added
	{"setarmor",		AICast_ScriptAction_Dummy},			//----(SA)	added
	{"giveinventory",	AICast_ScriptAction_Dummy},
	{"giveweapon",		AICast_ScriptAction_Dummy},
	{"takeweapon",		AICast_ScriptAction_Dummy},
	{"movetype",		AICast_ScriptAction_Dummy},
	{"alertentity",		AICast_ScriptAction_Dummy},
	{"savegame",		AICast_ScriptAction_Dummy},
	{"fireattarget",	AICast_ScriptAction_Dummy},
	{"godmode",			AICast_ScriptAction_Dummy},
	{"accum",			AICast_ScriptAction_Dummy},
	{"spawncast",		AICast_ScriptAction_Dummy},
	{"missionfailed",	AICast_ScriptAction_Dummy},
	{"missionsuccess",	AICast_ScriptAction_Dummy},
	{"objectivemet",	AICast_ScriptAction_Dummy},	// dupe of missionsuccess so scripts can changeover to a more logical name
	{"objectivesneeded",AICast_ScriptAction_Dummy},
	{"noaidamage",		AICast_ScriptAction_Dummy},
	{"print",			AICast_ScriptAction_Dummy},
	{"facetargetangles",AICast_ScriptAction_Dummy},
	{"resetscript",		AICast_ScriptAction_Dummy},
	{"mount",			AICast_ScriptAction_Dummy},
	{"unmount",			AICast_ScriptAction_Dummy},
	{"savepersistant",	AICast_ScriptAction_Dummy},
	{"changelevel",		AICast_ScriptAction_Dummy},
	{"endgame",			AICast_ScriptAction_Dummy},	//----(SA)	added
	{"teleport",		AICast_ScriptAction_Dummy},	//----(SA)	added
	{"foundsecret",		AICast_ScriptAction_Dummy},
	{"nosight",			AICast_ScriptAction_Dummy},
	{"sight",			AICast_ScriptAction_Dummy},
	{"noavoid",			AICast_ScriptAction_Dummy},
	{"avoid",			AICast_ScriptAction_Dummy},
	{"attrib",			AICast_ScriptAction_Dummy},
	{"denyactivate",	AICast_ScriptAction_Dummy},
	{"lightningdamage",	AICast_ScriptAction_Dummy},
	{"deny",			AICast_ScriptAction_Dummy},
	{"headlook",		AICast_ScriptAction_Dummy},
	{"backupscript",	AICast_ScriptAction_Dummy},
	{"restorescript",	AICast_ScriptAction_Dummy},
	{"statetype",		AICast_ScriptAction_Dummy},
	{"knockback",		AICast_ScriptAction_Dummy},
	{"zoom",			AICast_ScriptAction_Dummy},
	{"parachute",		AICast_ScriptAction_Dummy},
	{"cigarette",		AICast_ScriptAction_Dummy},	//----(SA)	added
	{"startcam",		AICast_ScriptAction_Dummy},
	{"startcamblack",	AICast_ScriptAction_Dummy},
	{"stopcam",			AICast_ScriptAction_Dummy},	//----(SA)	added
	{"entityscriptname",AICast_ScriptAction_Dummy},
	{"aiscriptname",	AICast_ScriptAction_Dummy},
	{"sethealth",		AICast_ScriptAction_Dummy},
	{"notarget",		AICast_ScriptAction_Dummy},
	{"cvar",			AICast_ScriptAction_Dummy},

//----(SA)	added some music interface
	{"mu_start",		AICast_ScriptAction_Dummy},	// (char *new_music, int time)	// time to fade in
	{"mu_play",			AICast_ScriptAction_Dummy},		// (char *new_music)
	{"mu_stop",			AICast_ScriptAction_Dummy},		// (int time)	// time to fadeout
	{"mu_fade",			AICast_ScriptAction_Dummy},		// (float target_volume, int time)	// time to fade to target
	{"mu_queue",		AICast_ScriptAction_Dummy},	// (char *new_music)	// music that will start when previous fades to 0
//----(SA)	end

	{"explicit_routing",	AICast_ScriptAction_Dummy},
	{"lockplayer",		AICast_ScriptAction_Dummy},
	{"anim_condition",	AICast_ScriptAction_Dummy},
	{"pushaway",		AICast_ScriptAction_Dummy},
	{"catchfire",		AICast_ScriptAction_Dummy},
...
void AICast_ScriptLoad( void )
{
	...
	if (len < 0)
	{
		G_Printf("^1AI script %s not loaded!!!\n", filename);
		return;
	}
	...
	G_Printf("^4AI script ^3%s^4 loaded.\n", filename);
...
//							gitem_t *weap = BG_FindItem(token);	// (SA) FIXME: rats, need to fix this for weapon names with spaces: 'mauser rifle'
//							if(weap)
