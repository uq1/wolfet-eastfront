...
static const weap_ws_convert_t aWeapID[WP_NUM_WEAPONS] = {
	...
	// UQ1: --- START EF NEW ---
	{ WP_PPSH,				WS_PPSH		},									// 39
	{ WP_STG44,				WS_STG44		},									// 40
	{ WP_PPS,				WS_BAR		},										// 41
	{ WP_SVT40,				WS_SVT40		},									// 42
	{ WP_30CAL,				WS_30CAL		},									// 43
	{ WP_30CAL_SET,			WS_30CAL },					// 55
	{ WP_PTRS,				WS_PTRS },               //56
	{ WP_AIRDROP_MARKER,	WS_MAX },
	{ WP_PTRS_SET,			WS_PTRS },       //57  ; Hi UQ1 , I am Masteries hehe 
	// UQ1: --- END EF NEW ---
#endif //__EF__
};
