...
//		&client->sess.experience,
		...
		(int *)&client->sess.auto_mute_time,
		&client->sess.ignoreClients[0],
		&client->sess.ignoreClients[1],
		&client->pers.enterTime,
...
//	sess->experience = 0;
	...
	// josh:
	sess->overall_killrating = 1600;
	sess->playerrating = 1600;
