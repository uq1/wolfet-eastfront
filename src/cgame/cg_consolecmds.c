...
static void CG_SelectBuddy_f( void ) {
	...
	// 0 - MAX_FIRETEAM_MEMBERS, not just limited to 6/fireteam
	// -1 = none
	// -2 = all
	...
	} else if ( pos >= 0 && pos < MAX_FIRETEAM_MEMBERS ) {
...
extern void CG_DoAim_f ( void );
#endif //__WEAPON_AIM__

#ifdef __ETE__
#ifdef __BOT__
extern void CG_Commander_Menu_Toggle ( void );
#endif //__BOT__
#endif //__ETE__

#ifdef __BOT__
extern void AIMod_AutoWaypoint ( void );
extern void AIMod_AutoWaypoint_Optimizer ( void );
extern void AIMod_AutoWaypoint_Clean ( void );
//extern void AIMod_AutoWaypoint_ListWaypointEntities ( void );
extern void CG_ShowSlope ( void );
extern void CG_ShowSurface ( void );
#endif //__BOT__

extern void CG_ListSecondaries_f ( void );
extern void CG_ListWeaponBanks ( void );
extern void CG_ListWeapons ( void );
...
#ifdef __ETE__
#ifdef __BOT__
	{ "cmdtoggle", CG_Commander_Menu_Toggle },
	{ "showslope", CG_ShowSlope },
	{ "showsurface", CG_ShowSurface },
	{ "aw", AIMod_AutoWaypoint },
	{ "autowaypoint", AIMod_AutoWaypoint },
	{ "aw_optimize", AIMod_AutoWaypoint_Optimizer },
	{ "autowaypoint_optimize", AIMod_AutoWaypoint_Optimizer },
	{ "awo", AIMod_AutoWaypoint_Optimizer },
	{ "aw_clean", AIMod_AutoWaypoint_Clean },
	{ "autowaypoint_clean", AIMod_AutoWaypoint_Clean },
	{ "awc", AIMod_AutoWaypoint_Clean },
//	{ "aw_listents", AIMod_AutoWaypoint_ListWaypointEntities },
#endif //__BOT__
#endif //__ETE__
	...
	{ "cgamesecondaries", CG_ListSecondaries_f },
	{ "listweaponbanks", CG_ListWeaponBanks },
	{ "listweapons", CG_ListWeapons },
};
