...
typedef rectDef_t etetRectangle;

// FIXME: do something to separate text vs window stuff
typedef struct {
	etetRectangle rect;					// client coord etetRectangle
	etetRectangle rectClient;			// screen coord etetRectangle
	const char *name;				//
	const char *model;				//
	...
	etetRectangle rectEffects;			// for various effects
	etetRectangle rectEffects2;			// for various effects
...
typedef struct itemDef_s {
	...
	etetRectangle textRect;				// etetRectangle the text ( if any ) consumes     
